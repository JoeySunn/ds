...
(function($) {
    function Slider(elem, options) {
        ...
        this.options = $.extend({}, this.default1, options);
    ...
    Slider.prototype = {
        create: function() {
            ...
            function initDOM() {
                var template = '<div class="slide-to-unlock-bg"><b style="height:50px;line-height:50px;">' +
                    options.text +
                    '</b></div><div class="slide-to-unlock-progress" style="width:0;overflow:hidden;"><div style="width:324px;height: 48px;line-height:48px;text-align:center;background:rgba(0,0,0,0);">解锁成功</div></div><div class="slide-to-unlock-handle" style="text-align:center;">>></div>';
