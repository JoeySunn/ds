		...
		create : function(mode){
			...
			if(mode === "days") {
				if(that.options.mode === 'calendar') {
					that.tHead = $('<thead><tr><th id="prev">&lsaquo;</th><th colspan="5" id="currM"></th><th id="next">&rsaquo;</th></tr><tr><th>日</th><th>一</th><th>二u</th><th>三</th><th>四</th><th>五</th><th>六</th></tr></thead>');
		...
		return $(this).each(function(){
			...
			if(typeof opts === 'string') {
				...
				cal.hover(function(){
					...
					that.text(e.date).trigger('onchange');
